  ...
  <div class="rounded-t mb-0 px-0 border-0">
    <div class="flex flex-wrap items-center px-4 py-2">
      <div class="relative w-full max-w-full flex-grow flex-1">
        <h3 class="mt-3  ml-6 font-semibold text-base text-gray-900 dark:text-gray-50">Categoria</h3>
      </div>
        ...
        <section class="text-white  body-font overflow-hidden">
            <div class="container px-5 py-24 mx-auto">
              <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="{{ asset('uploads/'. $product->picture) }}">
                  ...
                  <div class=" w-full overflow-x-auto flex justify-center">
                    <table class="m-6 w-full text-left border-collapse">
                      <tbody>
                              ...
                              <tr class="hover:bg-grey-lighter">
                                <td class="py-4 px-6 border-b border-grey-light">Precio de venta</td>
                                <td class="py-4 px-6 border-b border-grey-light">{{ $product->sale_price }}</td>
                              </tr>
                              <tr class="hover:bg-grey-lighter">
                                <td class="py-4 px-6 border-b border-grey-light">Stock</td>
                                <td class="py-4 px-6 border-b border-grey-light">{{ $product->stock }}</td>
                              </tr>
                              <tr class="hover:bg-grey-lighter">
                                <td class="py-4 px-6 border-b border-grey-light">Categoria</td>
                                <td class="py-4 px-6 border-b border-grey-light">{{ $product->category->name }}</td>
                              </tr>
                              <tr class="hover:bg-grey-lighter">
                                <td class="py-4 px-6 border-b border-grey-light">Subcategoria</td>
                                <td class="py-4 px-6 border-b border-grey-light">{{ $product->subcategory->name }}</td>
                              </tr>
                              <tr class="hover:bg-grey-lighter">
                                <td class="py-4 px-6 border-b border-grey-light">Marca</td>
