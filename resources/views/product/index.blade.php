    ...
    <div class="flex flex-wrap items-center px-4 py-2">
      ...
      <div class="relative w-full max-w-full flex-grow flex-1 text-right">
        ...
        <div class="flex justify-end items-end">
            ...
            <ul
              ...
              <li>
                <a
                  ...
                  href="{{ route('product.create_xlsx') }}"
                  data-te-dropdown-item-ref
                  >
          ...
          <a href="{{ route('import.create') }}" class="inline-flex px-5 py-3 text-white bg-gray-600 hover:bg-gray-700 focus:bg-gray-700 rounded-md m-5">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="flex-shrink-0 h-6 w-6 text-white -ml-1 mr-2">
