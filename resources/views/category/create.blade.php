      ...
      <div class="rounded-t mb-0 px-0 border-0">
        <div class="px-4 py-2">
          <div class="mt-4 relative w-full max-w-full flex-grow flex-1">
            <h3 class="ml-6 font-semibold text-base text-gray-900 dark:text-gray-50">Nueva Categoria</h3>
          </div>
        ...
        <form class="w-1/2 m-9 " action="{{ route('category.store') }}" method="POST" novalidate>
            @csrf
