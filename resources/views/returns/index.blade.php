...
@push('js')
    <script src="{{ asset('js/new_return.js') }}" type="module"></script>
@endpush
  ...
  <div class="rounded-t mb-0 px-0 border-0">
    <div class="flex flex-wrap items-center px-4 py-2">
      <div class="relative w-full max-w-full flex-grow flex-1">
        <h3 class=" ml-6 font-semibold text-base text-gray-900 dark:text-gray-50">Lista de devoluciones</h3>
      </div>
      <div class="relative w-full max-w-full flex-grow flex-1 text-right">
        ...
        <div class="flex justify-end items-end">
            ...
            <ul
              ...
              <li>
                <a
                  ...
                  href="{{ route('returns.create_xlsx') }}"
                  data-te-dropdown-item-ref
                  >
          ...
          <a href="#" data-modalBtn data-te-toggle="modal"
        ...
        <tbody>
          @if ($returns->count())
            ...
            <tr class="hover:bg-grey-lighter">
              <td class="py-4 px-6 border-b border-grey-light">{{ $return->sale->user->username }}</td>
              <td class="py-4 px-6 border-b border-grey-light">{{ $return->created_at->format('d/m/Y') }}</td>
              <td class="py-4 px-6 border-b border-grey-light">{{ $return->code }}</td>
              <td class="py-4 px-6 border-b border-grey-light">{{ $return->detalles->count() }}</td>
              <td class="py-4 px-6 border-b border-grey-light">{{ $return->sale->client->name }}</td>
...
<div
  ...
  <div
    ...
    <div
      ...
      <!--Modal body-->
      <p class="m-4">Seleccione una venta para realizar una devolucion</p>
      <div data-te-modal-body-ref class="relative p-4">
        <div class="relative z-0 w-full mb-6 group">
          <label for="sale_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Referencia de Venta</label>
          <select name="sale_id" id="sale_id" data-saleid data-te-select-init data-te-select-filter="true">
