        ...
        <tbody>
          @if ($sales->count())
            ...
            <tr class="hover:bg-grey-lighter">
              ...
              <td class="py-4 px-6 border-b border-grey-light">{{ $sale->created_at->format('d/m/Y') }}</td>
              <td class="py-4 px-6 border-b border-grey-light">{{ $sale->code }}</td>
              <td class="py-4 px-6 border-b border-grey-light">{{ $sale->detalles->count() }}</td>
              <td class="py-4 px-6 border-b border-grey-light">{{ $sale->client->name }}</td>
