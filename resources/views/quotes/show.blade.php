    ...
    <div class=" flex flex-wrap items-center px-4 py-2">
      <div class=" border-b-2 relative w-full max-w-full flex-grow flex-1">
        <div class="m-5 flex justify-between">
            <h3 class=" ml-6 font-semibold text-base text-gray-900 dark:text-gray-50">Detalles de Cotizacion: {{ $quote->code }}</h3>
            <div class="flex ">
                  ...
                  <ul
                    ...
                    <li>
                      <a
                        ...
                        href="{{ route('quotes.exportXlsx', $quote) }}"
                        data-te-dropdown-item-ref
                        >
    ...
    <div class="flex justify-between m-6 md:bg-green">
        <div>
            ...
            <ul>
                ...
                <li>{{ $quote->client->telefono }}</li>
                <li>{{ $quote->client->direccion }}</li>
            </ul>
        </div>
        <div>
            <p class="text-blue-400">Informacion de Cotizacion</p>
            <ul>
                <li>Referencia: {{ $quote->code }}</li>
                <li>Vendendor: {{ $quote->user->username }}</li>
                <li>Subtotal: $ {{ $quote->total * .84 }}</li>
                <li>IVA: $ {{ $quote->total * .16 }}</li>
...
<div class="m-6">
    <a type="button" href="{{ route('quotes.index') }}" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Cancelar</a>    
</div>  
</div>
<!-- ./Social Traffic -->
</div>
