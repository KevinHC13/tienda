      ...
      <div class="rounded-t mb-0 px-0 border-0">
        ...
        <form class="w-1/2 m-9 " action="{{ route('client.store') }}" method="POST" novalidate>
            ...
            <div  class="relative z-0 w-full mb-6 group">
                ...
                <select data-paisselect name="pais" id="pais" data-te-select-init data-te-select-filter="true">
                </select>
                @error('pais')
                    <p class="text-red-600 my-2 rounded-lg text-sm p-2 text-center" >{{ $message }}</p>
                @enderror
            ...
            <div  class="relative z-0 w-full mb-6 group">
                ...
                <select data-estadoselect name="estado" id="estado" data-te-select-init data-te-select-filter="true">
                </select>
                @error('estado')
                    <p class="text-red-600 my-2 rounded-lg text-sm p-2 text-center" >{{ $message }}</p>
                @enderror
            ...
            <div  class="relative z-0 w-full mb-6 group">
                ...
                <select data-ciudadselect name="ciudad" id="ciudad" data-te-select-init data-te-select-filter="true">
                </select>
                @error('ciudad')
                    <p class="text-red-600 my-2 rounded-lg text-sm p-2 text-center" >{{ $message }}</p>
                @enderror
